            ...
            <main className="flex-grow pt-24 pb-16">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <h2 className="relative z-10 text-3xl font-bold text-gray-900 mb-6">Pourquoi LOCAL ?</h2>
                            ...
                            >
                                {[
                                    ...
                                    <motion.div key={index} variants={fadeInUp} className="flex p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow">
                                        <div className="mr-4">
                ...
                <section className="max-w-5xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl border-b-4 border-purple-500 inline-block pb-2 font-bold text-gray-900 mb-4">L'Équipe</h2>
                        <p className="text-gray-600 text-lg">Les esprits derrière le projet</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                        ...
                        >
                            ...
                            <div className="p-8 text-center">
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">Romuld ZOUNGLA</h3>
                        ...
                        >
                            ...
                            <div className="p-8 text-center">
                                <h3 className="text-2xl font-bold text-gray-900 mb-2">Jules-christ GBASSI</h3>
