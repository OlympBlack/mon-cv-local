          ...
          >
            <Accordion type="single" collapsible className="w-full space-y-2">
              {items.map((item, index) => (
                <AccordionItem key={index} value={`item-${index}`} className="border-b border-gray-300 last:border-none">
                  <AccordionTrigger className="text-gray-900 text-lg font-medium py-4 hover:no-underline hover:text-gray-600">
                    {item.question}
                  </AccordionTrigger>
